...
const val flowUseCase1Description = "#1 Collect Flow - ViewModel exposes LiveData"
const val flowUseCase2Description = "#2 Collect Flow from Room database"
const val flowUseCase3Description = "#3 Collect Flow - ViewModel exposes Flow"
