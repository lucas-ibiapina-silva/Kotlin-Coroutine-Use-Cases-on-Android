...
import com.lukaslechner.coroutineusecasesonandroid.usecases.flow.useCaseCallbackFlow.CallbackFlowViewModel.NetworkState
...
class FlowUseCase5Activity : BaseActivity() {
    ...
    private val viewModel: CallbackFlowViewModel by viewModels {
        ViewModelFactory(
            this@FlowUseCase5Activity,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                ...
                launch {
                    viewModel.networkStatus.collect { networkState ->
                        when (networkState) {
